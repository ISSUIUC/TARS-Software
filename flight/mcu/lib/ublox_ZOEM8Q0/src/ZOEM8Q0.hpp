 ...
 *
 * Utilizes SPI communication and the standard NMEA protocol to find the
 * latitude, longitude, and altitude. Data Sheet:
 * https://www.u-blox.com/sites/default/files/ZOE-M8_DataSheet_%28UBX-16008094%29.pdf
