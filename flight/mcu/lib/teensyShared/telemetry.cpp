...
void Telemetry::transmit(const sensorDataStruct_t& data_struct) {
    ...
    Serial.print(data_struct.LSM_IMU_mx, 5);
    Serial.print(',');
    Serial.print(R"("LSM_IMU_my":)");
    Serial.print(data_struct.LSM_IMU_my, 5);
    Serial.print(',');
    Serial.print(R"("LSM_IMU_mz":)");
    Serial.print(data_struct.LSM_IMU_mz, 5);
    Serial.print(',');
    Serial.print(R"("FSM_state":)");
    Serial.print(data_struct.FSM_state);
    Serial.print(',');
    Serial.print(R"("sign":")");
    Serial.print("SIGN");
    Serial.print("\",");
    ...
    Serial.print(data_struct.voltage_battry, 5);
    Serial.print(',');
    Serial.print(R"("frequency":)");
    Serial.print(RF95_FREQ);
    Serial.print(',');
    Serial.print(R"("flap_extension":)");
    Serial.print(data_struct.flap_extension, 5);
    Serial.print(",");
    Serial.print(R"("STE_ALT":)");
    Serial.print(data_struct.state_x, 5);
    Serial.print(",");
    Serial.print(R"("STE_VEL":)");
    Serial.print(data_struct.state_vx, 5);
    Serial.print(",");
    Serial.print(R"("STE_ACC":)");
    Serial.print(data_struct.state_ax, 5);
    Serial.print(",");
    Serial.print(R"("TEMP":)");
    Serial.print(data_struct.barometer_temp);
    Serial.print(",");
    Serial.print(R"("pressure":)");
    Serial.print(data_struct.barometer_pressure, 5);
    Serial.print(",");
    Serial.print(R"("STE_APO":)");
    Serial.print(data_struct.state_apo, 5);
    Serial.print("");
    Serial.println("}}");
#endif
