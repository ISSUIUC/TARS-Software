...
HistoryBufferFSM50::HistoryBufferFSM50(pointers *ptr) {
    ...
    altitude_history_ptr_ =
        &pointer_struct->dataloggerTHDVarsPointer.altitude_history_50;
    IMU_acceleration_history_ptr_ =
        &pointer_struct->dataloggerTHDVarsPointer.IMU_acceleration_history_50;
}
