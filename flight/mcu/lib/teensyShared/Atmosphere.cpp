...
double Atmosphere::getPressure(double altitude) {
    ...
    if (altitude_h < 11) {
        pressure = 101325.0 * pow((288.15 / (288.15 - 6.5 * altitude_h)), (34.1632 / -6.5));
        ...
        pressure = 868.0187 * pow((228.65 / (228.65 + 2.8 * (altitude_h - 32))), (34.1632 / 2.8));
    } else if (altitude_h < 51) {
        pressure = 110.9063 * exp(-34.1632 * (altitude_h - 47) / 270.65);
    } else if (altitude_h < 71) {
        pressure = 66.93887 * pow((270.65 / (270.65 - 2.8 * (altitude_h - 51))), (34.1632 / -2.8));
    } else if (altitude_h < 84.852) {
        pressure = 3.956420 * pow((214.65 / (214.65 - 2 * (altitude_h - 71))), (34.1632 / -2));
    } else if (altitude_h < 91) {
        pressure = exp(0.000000 * pow(altitude_h, 4) + 2.159582E-06 * pow(altitude_h, 3) +
                       -4.836957E-04 * pow(altitude_h, 2) + -0.1425192 * altitude_h + 13.47530);
    } else if (altitude_z < 100) {
        pressure = exp(0.000000 * pow(altitude_z, 4) + 3.304895E-05 * pow(altitude_z, 3) +
                       -0.009062730 * pow(altitude_z, 2) + 0.6516698 * altitude_z + -11.03037);
    } else if (altitude_z < 110) {
        pressure = exp(0.000000 * pow(altitude_z, 4) + 6.693926E-05 * pow(altitude_z, 3) +
                       -0.01945388 * pow(altitude_z, 2) + 1.719080 * altitude_z + -47.75030);
    } else if (altitude_z < 120) {
        pressure = exp(0.000000 * pow(altitude_z, 4) + -6.539316E-05 * pow(altitude_z, 3) +
                       0.02485568 * pow(altitude_z, 2) + -3.223620 * altitude_z + 135.9355);
    } else if (altitude_z < 150) {
        pressure = exp(2.283506E-07 * pow(altitude_z, 4) + -1.343221E-04 * pow(altitude_z, 3) +
                       0.02999016 * pow(altitude_z, 2) + -3.055446 * altitude_z + 113.5764);
    } else if (altitude_z < 200) {
        pressure = exp(1.209434E-08 * pow(altitude_z, 4) + -9.692458E-06 * pow(altitude_z, 3) +
                       0.003002041 * pow(altitude_z, 2) + -0.4523015 * altitude_z + 19.19151);
    } else if (altitude_z < 300) {
        pressure = exp(8.113942E-10 * pow(altitude_z, 4) + -9.822568E-07 * pow(altitude_z, 3) +
                       4.687616E-04 * pow(altitude_z, 2) + -0.1231710 * altitude_z + 3.067409);
    } else if (altitude_z < 500) {
        pressure = exp(9.814674E-11 * pow(altitude_z, 4) + -1.654439E-07 * pow(altitude_z, 3) +
                       1.148115E-04 * pow(altitude_z, 2) + -0.05431334 * altitude_z + -2.011365);
    } else if (altitude_z < 750) {
        pressure = exp(-7.835161E-11 * pow(altitude_z, 4) + 1.964589E-07 * pow(altitude_z, 3) +
                       -1.657213E-04 * pow(altitude_z, 2) + 0.04305869 * altitude_z + -14.77132);
    } else if (altitude_z < 1000) {
        pressure = exp(2.813255E-11 * pow(altitude_z, 4) + -1.120689E-07 * pow(altitude_z, 3) +
...
double Atmosphere::getDensity(double altitude) {
    ...
    if (altitude < 84.853) {
        ...
        density = exp(0.000000 * pow(altitude, 4) + -3.322622E-06 * pow(altitude, 3) + 9.111460E-04 * pow(altitude, 2) +
                      -0.2609971 * altitude + 5.944694);
    } else if (altitude < 100) {
        density = exp(0.000000 * pow(altitude, 4) + 2.873405E-05 * pow(altitude, 3) + -0.008492037 * pow(altitude, 2) +
                      0.6541179 * altitude + -23.62010);
    } else if (altitude < 110) {
        density = exp(-1.240774E-05 * pow(altitude, 4) + 0.005162063 * pow(altitude, 3) +
                      -0.8048342 * pow(altitude, 2) + 55.55996 * altitude + -1443.338);
    } else if (altitude < 120) {
        density = exp(0.00000 * pow(altitude, 4) + -8.854164E-05 * pow(altitude, 3) + 0.03373254 * pow(altitude, 2) +
                      -4.390837 * altitude + 176.5294);
    } else if (altitude < 150) {
        density = exp(3.661771E-07 * pow(altitude, 4) + -2.154344E-04 * pow(altitude, 3) +
                      0.04809214 * pow(altitude, 2) + -4.884744 * altitude + 172.3597);
    } else if (altitude < 200) {
        density = exp(1.906032E-08 * pow(altitude, 4) + -1.527799E-05 * pow(altitude, 3) +
                      0.004724294 * pow(altitude, 2) + -0.6992340 * altitude + 20.50921);
    } else if (altitude < 300) {
        density = exp(1.199282E-09 * pow(altitude, 4) + -1.451051E-06 * pow(altitude, 3) +
                      6.910474E-04 * pow(altitude, 2) + -0.1736220 * altitude + -5.321644);
    } else if (altitude < 500) {
        density = exp(1.140564E-10 * pow(altitude, 4) + -2.130756E-07 * pow(altitude, 3) +
                      1.570762E-04 * pow(altitude, 2) + -0.07029296 * altitude + -12.89844);
    } else if (altitude < 750) {
        density = exp(8.105631E-12 * pow(altitude, 4) + -2.358417E-09 * pow(altitude, 3) +
                      -2.635110E-06 * pow(altitude, 2) + -0.01562608 * altitude + -20.02246);
    } else if (altitude < 1000) {
        density = exp(-3.701195E-12 * pow(altitude, 4) + -8.608611E-09 * pow(altitude, 3) +
                      5.118829E-05 * pow(altitude, 2) + -0.06600998 * altitude + -6.137674);
    } else {
        density = 0;
    }
