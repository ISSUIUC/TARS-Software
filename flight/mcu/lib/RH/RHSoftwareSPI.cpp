...
// Caution: on Arduino Uno and many other CPUs, digitalWrite is quite slow,
// taking about 4us digitalWrite is also slow, taking about 3.5us resulting in
// very slow SPI bus speeds using this technique, up to about 120us per octet of
// transfer
...
void RHSoftwareSPI::begin() {
    ...
    // Caution: these counts assume that digitalWrite is very fast, which is
    // usually not true
    switch (_frequency) {
        case Frequency1MHz:
            _delayCounts = 8;
