...
uint8_t RH_RF24::_interruptCount =
...
PROGMEM const uint8_t RF24_CONFIGURATION_DATA[] =
...
bool RH_RF24::init() {
    ...
    if (_deviceType != 0x4460 && _deviceType != 0x4461 &&
        _deviceType != 0x4463 && _deviceType != 0x4464)
    ...
    // radio_config
    uint8_t int_ctl[] = {RH_RF24_MODEM_INT_STATUS_EN | RH_RF24_PH_INT_STATUS_EN,
                         0xff, 0xff, 0x00};
...
void RH_RF24::setModeRx() {
    if (_mode != RHModeRx) {
        ...
        uint8_t rx_config[] = {0x00,      RH_RF24_CONDITION_RX_START_IMMEDIATE,
                               0x00,      0x00,
                               _idleMode, _idleMode,
                               _idleMode};
...
void RH_RF24::setTxPower(uint8_t power) {
    ...
    uint8_t power_properties[] = {
        0x08, 0x00, 0x00};  // PA_MODE from WDS sugggestions (why?)
...
float RH_RF24::get_temperature() {
    ...
    return ((800 + read_buf[6]) / 4096.0) * temp_adc -
           ((read_buf[7] / 2) + 256);
}
