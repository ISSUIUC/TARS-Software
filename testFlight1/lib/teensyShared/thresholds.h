...
float main_thresh_min = -2; //still not determined
float main_thresh_max = -1; //still not determined
float drogue_thresh = -2; //still not determined
...
float drogue_time_thresh = 2000;
float main_time_thresh = 2000;
