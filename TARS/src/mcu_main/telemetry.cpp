...
void Telemetry::serialPrint(const sensorDataStruct_t &sensor_data) {
    ...
    Serial.print(R"("STE_POS_X":)");
    Serial.print(sensor_data.kalman_data.kalman_pos_x, 5);
    Serial.print(",");
    Serial.print(R"("STE_VEL_X":)");
    Serial.print(sensor_data.kalman_data.kalman_vel_x, 5);
    Serial.print(",");
    Serial.print(R"("STE_ACC_X":)");
    Serial.print(sensor_data.kalman_data.kalman_acc_x, 5);
    Serial.print(",");
    Serial.print(R"("STE_POS_y":)");
    Serial.print(sensor_data.kalman_data.kalman_pos_y, 5);
    Serial.print(",");
    Serial.print(R"("STE_VEL_y":)");
    Serial.print(sensor_data.kalman_data.kalman_vel_y, 5);
    Serial.print(",");
    Serial.print(R"("STE_ACC_y":)");
    Serial.print(sensor_data.kalman_data.kalman_acc_y, 5);
    Serial.print(",");
    Serial.print(R"("STE_POS_z":)");
    Serial.print(sensor_data.kalman_data.kalman_pos_z, 5);
    Serial.print(",");
    Serial.print(R"("STE_VEL_z":)");
    Serial.print(sensor_data.kalman_data.kalman_vel_z, 5);
    Serial.print(",");
    Serial.print(R"("STE_ACC_z":)");
    Serial.print(sensor_data.kalman_data.kalman_acc_z, 5);
    Serial.print(",");
    Serial.print(R"("TEMP":)");
