...
bool RH_CC110::init() {
    ...
    spiWriteRegister(RH_CC110_REG_02_IOCFG0,
    ...
    spiWriteRegister(RH_CC110_REG_13_MDMCFG1,
...
uint8_t RH_CC110::spiReadRegister(uint8_t reg) { return spiRead((reg & 0x3f) | RH_CC110_SPI_READ_MASK); }
