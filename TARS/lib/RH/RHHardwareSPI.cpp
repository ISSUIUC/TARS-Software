...
// Arduino Due has default SPI pins on central SPI headers, and not on 10, 11,
// 12, 13 as per other Arduinos
...
void RHHardwareSPI::begin() {
    ...
    switch (_frequency) {
        ...
        case Frequency16MHz:
            divider = SPI_CLOCK_DIV2;  // Not really 16MHz, only 8MHz. 4MHz on
                                       // an 8MHz Arduino
            break;
    }
    ...
    // Requires SPI driver for ESP8266 from
    // https://github.com/esp8266/Arduino/tree/master/libraries/SPI Which ppears
    // to be in Arduino Board Manager ESP8266 Community version 2.1.0
