...
class JSON {
   public:
    JSON() {
        ...
        Nan::MaybeLocal<v8::Value> maybe_global_json =
            Nan::Get(Nan::GetCurrentContext()->Global(),
                     Nan::New("JSON").ToLocalChecked());

        assert(!maybe_global_json.IsEmpty() && "global JSON is empty");
        v8::Local<v8::Value> val_global_json =
            maybe_global_json.ToLocalChecked();
        ...
        assert(!maybe_obj_global_json.IsEmpty() &&
               "global JSON object is empty");
        v8::Local<v8::Object> global_json =
            maybe_obj_global_json.ToLocalChecked();

#if NAN_JSON_H_NEED_PARSE
        Nan::MaybeLocal<v8::Value> maybe_parse_method =
            Nan::Get(global_json, Nan::New("parse").ToLocalChecked());
        ...
        Nan::MaybeLocal<v8::Value> maybe_stringify_method =
            Nan::Get(global_json, Nan::New("stringify").ToLocalChecked());
        ...
        assert(stringify_method->IsFunction() &&
    ...
    inline Nan::MaybeLocal<v8::Value> Parse(v8::Local<v8::String> json_string) {
    ...
    inline Nan::MaybeLocal<v8::String> Stringify(
    ...
    inline Nan::MaybeLocal<v8::String> Stringify(
        v8::Local<v8::Object> json_object, v8::Local<v8::String> gap) {
        Nan::EscapableHandleScope scope;
        Nan::MaybeLocal<v8::String> result =
#if NAN_JSON_H_NEED_STRINGIFY
   ...
   private:
    ...
    inline v8::Local<v8::Value> parse(v8::Local<v8::Value> arg) {
        ...
        return parse_cb_.Call(1, &arg, &resource)
    ...
    inline v8::Local<v8::Value> stringify(v8::Local<v8::Value> arg,
        ...
        v8::Local<v8::Value> argv[] = {arg, Nan::Null(), gap};
        AsyncResource resource("nan:JSON.stringify");
