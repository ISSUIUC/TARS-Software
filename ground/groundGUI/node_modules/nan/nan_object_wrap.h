...
class ObjectWrap {
   public:
    ...
    inline v8::Local<v8::Object> handle() const { return New(handle_); }

    inline Persistent<v8::Object>& persistent() { return handle_; }
   ...
   protected:
    ...
    inline void MakeWeak() {
        persistent().v8::PersistentBase<v8::Object>::SetWeak(this,
                                                             WeakCallback);
        persistent().MarkIndependent();
    }
   ...
   private:
    ...
    static void WeakCallback(
        v8::WeakCallbackData<v8::Object, ObjectWrap> const& data) {
