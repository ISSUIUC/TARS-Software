...
class PersistentBase {
   ...
   public:
    inline PersistentBase() : persistent() {}
   ...
   private:
    inline explicit PersistentBase(v8::Persistent<T> that) : persistent(that) {}
...
class Persistent : public PersistentBase<T> {
   public:
    ...
    template <typename S>
    inline Persistent(v8::Handle<S> that)
    ...
    inline Persistent(const Persistent<S, M2> &that) : PersistentBase<T>() {
        Copy(that);
    }
