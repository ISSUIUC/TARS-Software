...
inline MaybeLocal<v8::String> ToDetailString(v8::Local<v8::Value> val) {
...
inline MaybeLocal<v8::Uint32> ToArrayIndex(v8::Local<v8::Value> val) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline MaybeLocal<v8::Object> NewInstance(v8::Local<v8::Function> h) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline MaybeLocal<v8::Object> NewInstance(v8::Local<v8::ObjectTemplate> h) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
    return scope.Escape(h->NewInstance(isolate->GetCurrentContext())
                            .FromMaybe(v8::Local<v8::Object>()));
...
inline Maybe<bool> Set(v8::Local<v8::Object> obj, v8::Local<v8::Value> key,
...
inline Maybe<bool> Set(v8::Local<v8::Object> obj, uint32_t index,
                       v8::Local<v8::Value> value) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline Maybe<bool> DefineOwnProperty(v8::Local<v8::Object> obj,
...
NAN_DEPRECATED inline Maybe<bool> ForceSet(
    ...
    v8::Local<v8::Value> value, v8::PropertyAttribute attribs = v8::None) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline MaybeLocal<v8::Value> Get(v8::Local<v8::Object> obj, uint32_t index) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline v8::PropertyAttribute GetPropertyAttributes(v8::Local<v8::Object> obj,
                                                   v8::Local<v8::Value> key) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline Maybe<bool> Delete(v8::Local<v8::Object> obj,
                          v8::Local<v8::String> key) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline Maybe<bool> Delete(v8::Local<v8::Object> obj, uint32_t index) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
    return obj->Delete(isolate->GetCurrentContext(), index);
}

inline MaybeLocal<v8::Array> GetPropertyNames(v8::Local<v8::Object> obj) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline Maybe<bool> SetPrototype(v8::Local<v8::Object> obj,
...
inline MaybeLocal<v8::String> ObjectProtoToString(v8::Local<v8::Object> obj) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline Maybe<bool> HasOwnProperty(v8::Local<v8::Object> obj,
                                  v8::Local<v8::String> key) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline Maybe<bool> HasRealNamedProperty(v8::Local<v8::Object> obj,
                                        v8::Local<v8::String> key) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline Maybe<bool> HasRealIndexedProperty(v8::Local<v8::Object> obj,
                                          uint32_t index) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline Maybe<bool> HasRealNamedCallbackProperty(v8::Local<v8::Object> obj,
                                                v8::Local<v8::String> key) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::HandleScope scope(isolate);
...
inline MaybeLocal<v8::Value> GetRealNamedProperty(v8::Local<v8::Object> obj,
                                                  v8::Local<v8::String> key) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
    return scope.Escape(
...
inline MaybeLocal<v8::Value> CallAsFunction(v8::Local<v8::Object> obj,
...
inline MaybeLocal<v8::Value> CallAsConstructor(v8::Local<v8::Object> obj,
                                               int argc,
                                               v8::Local<v8::Value> argv[]) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline MaybeLocal<v8::String> GetSourceLine(v8::Local<v8::Message> msg) {
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
...
inline MaybeLocal<v8::Object> CloneElementAt(v8::Local<v8::Array> array,
                                             uint32_t index) {
    ...
    v8::EscapableHandleScope scope(isolate);
    return scope.Escape(
        array->CloneElementAt(isolate->GetCurrentContext(), index)
            .FromMaybe(v8::Local<v8::Object>()));
#endif
}
...
inline MaybeLocal<v8::Value> Call(v8::Local<v8::Function> fun,
    ...
    v8::EscapableHandleScope scope(isolate);
    return scope.Escape(
        fun->Call(isolate->GetCurrentContext(), recv, argc, argv)
            .FromMaybe(v8::Local<v8::Value>()));
}
