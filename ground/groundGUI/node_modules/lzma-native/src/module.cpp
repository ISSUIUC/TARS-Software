...
static Napi::Object moduleInit(Env env, Object exports) {
    ...
    exports["filterEncoderIsSupported"] =
        Function::New(env, lzmaFilterEncoderIsSupported);
    exports["filterDecoderIsSupported"] =
        Function::New(env, lzmaFilterDecoderIsSupported);
    ...
    exports["easyEncoderMemusage"] =
        Function::New(env, lzmaEasyEncoderMemusage);
    exports["easyDecoderMemusage"] =
        Function::New(env, lzmaEasyDecoderMemusage);
    ...
    exports["TELL_UNSUPPORTED_CHECK"] =
        Number::New(env, LZMA_TELL_UNSUPPORTED_CHECK);
    ...
    exports["VERSION_STABILITY_ALPHA"] =
        Number::New(env, LZMA_VERSION_STABILITY_ALPHA);
    exports["VERSION_STABILITY_BETA"] =
        Number::New(env, LZMA_VERSION_STABILITY_BETA);
    exports["VERSION_STABILITY_STABLE"] =
        Number::New(env, LZMA_VERSION_STABILITY_STABLE);
