/* Getopt for GNU.
   ...
   before changing it!
   Copyright (C)
   1987,88,89,90,91,92,93,94,95,96,98,99,2000,2001,2002,2003,2004,2006 Free
...
int _getopt_internal_r(int argc, char **argv, const char *optstring,
    ...
    if (d->optind == 0 || !d->__initialized) {
        ...
        optstring =
            _getopt_initialize(argc, argv, optstring, posixly_correct, d);
        d->__initialized = 1;
    }
...
#define NONOPTION_P (argv[d->optind][0] != '-' || argv[d->optind][1] == '\0')
    ...
    if (d->__nextchar == NULL || *d->__nextchar == '\0') {
        ...
        if (NONOPTION_P) {
            if (d->__ordering == REQUIRE_ORDER) return -1;
