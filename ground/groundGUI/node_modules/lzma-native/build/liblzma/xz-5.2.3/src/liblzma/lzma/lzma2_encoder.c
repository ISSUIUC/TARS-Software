    ...
    while (*out_pos < out_size) switch (coder->sequence) {
            case SEQ_INIT:
                ...
                if (mf_unencoded(mf) == 0) {
                    ...
                    if (mf->action == LZMA_FINISH) out[(*out_pos)++] = 0;
            ...
            case SEQ_LZMA_COPY:
                ...
                if (coder->buf_pos != coder->compressed_size) return LZMA_OK;
            ...
            case SEQ_UNCOMPRESSED_HEADER:
                ...
                if (coder->buf_pos != LZMA2_HEADER_UNCOMPRESSED) return LZMA_OK;
            ...
            case SEQ_UNCOMPRESSED_COPY:
                ...
                if (coder->uncompressed_size != 0) return LZMA_OK;
...
extern uint64_t lzma_lzma2_encoder_memusage(const void *options) {
    ...
    if (lzma_mem == UINT64_MAX) return UINT64_MAX;
