    ...
    while (*in_pos < in_size || coder->sequence == SEQ_LZMA)
        switch (coder->sequence) {
            case SEQ_CONTROL: {
                ...
                // End marker
                if (control == 0x00) return LZMA_STREAM_END;
                ...
                if (control >= 0x80) {
                    ...
                    if (control > 2) return LZMA_DATA_ERROR;
            ...
            case SEQ_LZMA: {
                ...
                if (in_used > coder->compressed_size) return LZMA_DATA_ERROR;
                ...
                if (coder->compressed_size != 0) return LZMA_DATA_ERROR;
            ...
            case SEQ_COPY: {
                ...
                if (coder->compressed_size != 0) return LZMA_OK;
...
extern lzma_ret lzma_lzma2_props_decode(void **options,
                                        ...
                                        const uint8_t *props,
                                        size_t props_size) {
    if (props_size != 1) return LZMA_OPTIONS_ERROR;

    // Check that reserved bits are unset.
    if (props[0] & 0xC0) return LZMA_OPTIONS_ERROR;

    // Decode the dictionary size.
    if (props[0] > 40) return LZMA_OPTIONS_ERROR;
