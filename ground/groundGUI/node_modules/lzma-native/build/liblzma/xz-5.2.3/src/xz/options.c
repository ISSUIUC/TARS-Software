...
static void parse_options(const char *str, const option_map *opts,
    ...
    while (*name != '\0') {
        ...
        while (true) {
            ...
            if (strcmp(name, opts[i].name) == 0) break;
        ...
        if (opts[i].map != NULL) {
            ...
            for (j = 0; opts[i].map[j].name != NULL; ++j) {
                if (strcmp(opts[i].map[j].name, value) == 0) break;
            }
    ...
    switch (key) {
        case OPT_PRESET: {
            ...
            if (valuestr[1] != '\0') {
                ...
                if (valuestr[2] != '\0') error_lzma_preset(valuestr);
            }

            if (lzma_lzma_preset(options, preset)) error_lzma_preset(valuestr);
...
extern lzma_options_lzma *options_lzma(const char *str) {
    ...
    if (lzma_lzma_preset(options, LZMA_PRESET_DEFAULT)) message_bug();
