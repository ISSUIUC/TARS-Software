...
void SerialPrintTelemetryData(const TelemetryPacket & packet, float frequency){
  ...
  for(int i = 0; i < packet.datapoint_count && i < 4; i++){
    ...
    Serial.print(R"("response_ID":)"); Serial.print(packet.response_ID); Serial.print(',');
    Serial.print(R"("gps_lat":)"); printFloat(packet.gps_lat); Serial.print(',');
    Serial.print(R"("gps_long":)"); printFloat(packet.gps_long); Serial.print(',');
    Serial.print(R"("gps_alt":)"); printFloat(packet.gps_alt); Serial.print(',');
    Serial.print(R"("barometer_alt":)"); printFloat(baro_altitude); Serial.print(',');
    Serial.print(R"("KX_IMU_ax":)"); printFloat(convert_range(data.highG_ax, 256)); Serial.print(',');
    Serial.print(R"("KX_IMU_ay":)"); printFloat(convert_range(data.highG_ay, 256)); Serial.print(',');
    Serial.print(R"("KX_IMU_az":)"); printFloat(convert_range(data.highG_az, 256)); Serial.print(',');
    ...
    Serial.print(R"("LSM_IMU_ax":)"); printFloat(0); Serial.print(',');
    Serial.print(R"("LSM_IMU_ay":)"); printFloat(0); Serial.print(',');
    Serial.print(R"("LSM_IMU_az":)"); printFloat(0); Serial.print(',');
    Serial.print(R"("LSM_IMU_gx":)"); printFloat(convert_range(data.gyro_x, 8192)); Serial.print(',');
    Serial.print(R"("LSM_IMU_gy":)"); printFloat(convert_range(data.gyro_y, 8192)); Serial.print(',');
    Serial.print(R"("LSM_IMU_gz":)"); printFloat(convert_range(data.gyro_z, 8192)); Serial.print(',');
    Serial.print(R"("LSM_IMU_mx":)"); printFloat(0); Serial.print(',');
    Serial.print(R"("LSM_IMU_my":)"); printFloat(0); Serial.print(',');
    Serial.print(R"("LSM_IMU_mz":)"); printFloat(0); Serial.print(',');
    Serial.print(R"("FSM_state":)"); Serial.print(packet.FSM_State); Serial.print(',');
    Serial.print(R"("sign":")"); Serial.print("NOSIGN"); Serial.print("\",");
    Serial.print(R"("RSSI":)"); Serial.print(rf95.lastRssi()); Serial.print(',');
    Serial.print(R"("Voltage":)"); printFloat(convert_range(packet.voltage_battery, 16)); Serial.print(',');
    ...
    Serial.print(R"("STE_ALT":)"); printFloat(packet.gnc_state_x); Serial.print(",");
    Serial.print(R"("STE_VEL":)"); printFloat(packet.gnc_state_vx); Serial.print(",");
    Serial.print(R"("STE_ACC":)"); printFloat(packet.gnc_state_ax); Serial.print(",");
    Serial.print(R"("TEMP":)"); printFloat(convert_range(data.barometer_temp, 128)); Serial.print(",");
    Serial.print(R"("pressure":)"); printFloat(convert_range(data.barometer_pressure, 4096)); Serial.print(",");
    Serial.print(R"("STE_APO":)"); printFloat(packet.gns_state_apo); Serial.print("");
