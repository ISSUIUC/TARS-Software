...
// Each interrupt can be handled by a different instance of RH_RF22, allowing
// you to have 2 RH_RF22s per Arduino
...
PROGMEM static const RH_RF22::ModemConfig MODEM_CONFIG_TABLE[] = {
    {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c, 0x00,
     0x08},  // Unmodulated carrier
    {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c, 0x33,
     0x08},  // FSK, PN9 random modulation, 2, 5

    // All the following enable FIFO with reg 71
    //  1c,   1f,   20,   21,   22,   23,   24,   25,   2c,   2d,   2e,   58,
    //  69,   6e,   6f,   70,   71,   72
    // FSK, No Manchester, Max Rb err <1%, Xtal Tol 20ppm
    {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c, 0x22,
     0x08},  // 2, 5
    {0x1b, 0x03, 0x41, 0x60, 0x27, 0x52, 0x00, 0x07, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x13, 0xa9, 0x2c, 0x22,
     0x3a},  // 2.4, 36
    {0x1d, 0x03, 0xa1, 0x20, 0x4e, 0xa5, 0x00, 0x13, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x27, 0x52, 0x2c, 0x22,
     0x48},  // 4.8, 45
    {0x1e, 0x03, 0xd0, 0x00, 0x9d, 0x49, 0x00, 0x45, 0x40, 0x0a, 0x20, 0x80, 0x60, 0x4e, 0xa5, 0x2c, 0x22,
     0x48},  // 9.6, 45
    {0x2b, 0x03, 0x34, 0x02, 0x75, 0x25, 0x07, 0xff, 0x40, 0x0a, 0x1b, 0x80, 0x60, 0x9d, 0x49, 0x2c, 0x22,
     0x0f},  // 19.2, 9.6
    {0x02, 0x03, 0x68, 0x01, 0x3a, 0x93, 0x04, 0xd5, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x09, 0xd5, 0x0c, 0x22,
     0x1f},  // 38.4, 19.6
    {0x06, 0x03, 0x45, 0x01, 0xd7, 0xdc, 0x07, 0x6e, 0x40, 0x0a, 0x2d, 0x80, 0x60, 0x0e, 0xbf, 0x0c, 0x22,
     0x2e},  // 57.6. 28.8
    {0x8a, 0x03, 0x60, 0x01, 0x55, 0x55, 0x02, 0xad, 0x40, 0x0a, 0x50, 0x80, 0x60, 0x20, 0x00, 0x0c, 0x22,
     0xc8},  // 125, 125

    {0x2b, 0x03, 0xa1, 0xe0, 0x10, 0xc7, 0x00, 0x09, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x04, 0x32, 0x2c, 0x22,
     0x04},  // 512 baud, FSK, 2.5 Khz fd for POCSAG compatibility
    {0x27, 0x03, 0xa1, 0xe0, 0x10, 0xc7, 0x00, 0x06, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x04, 0x32, 0x2c, 0x22,
     0x07},  // 512 baud, FSK, 4.5 Khz fd for POCSAG compatibility

    // GFSK, No Manchester, Max Rb err <1%, Xtal Tol 20ppm
    // These differ from FSK only in register 71, for the modulation type
    {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c, 0x23,
     0x08},  // 2, 5
    {0x1b, 0x03, 0x41, 0x60, 0x27, 0x52, 0x00, 0x07, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x13, 0xa9, 0x2c, 0x23,
     0x3a},  // 2.4, 36
    {0x1d, 0x03, 0xa1, 0x20, 0x4e, 0xa5, 0x00, 0x13, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x27, 0x52, 0x2c, 0x23,
     0x48},  // 4.8, 45
    {0x1e, 0x03, 0xd0, 0x00, 0x9d, 0x49, 0x00, 0x45, 0x40, 0x0a, 0x20, 0x80, 0x60, 0x4e, 0xa5, 0x2c, 0x23,
     0x48},  // 9.6, 45
    {0x2b, 0x03, 0x34, 0x02, 0x75, 0x25, 0x07, 0xff, 0x40, 0x0a, 0x1b, 0x80, 0x60, 0x9d, 0x49, 0x2c, 0x23,
     0x0f},  // 19.2, 9.6
    {0x02, 0x03, 0x68, 0x01, 0x3a, 0x93, 0x04, 0xd5, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x09, 0xd5, 0x0c, 0x23,
     0x1f},  // 38.4, 19.6
    {0x06, 0x03, 0x45, 0x01, 0xd7, 0xdc, 0x07, 0x6e, 0x40, 0x0a, 0x2d, 0x80, 0x60, 0x0e, 0xbf, 0x0c, 0x23,
     0x2e},  // 57.6. 28.8
    {0x8a, 0x03, 0x60, 0x01, 0x55, 0x55, 0x02, 0xad, 0x40, 0x0a, 0x50, 0x80, 0x60, 0x20, 0x00, 0x0c, 0x23,
     0xc8},  // 125, 125

    // OOK, No Manchester, Max Rb err <1%, Xtal Tol 20ppm
    {0x51, 0x03, 0x68, 0x00, 0x3a, 0x93, 0x01, 0x3d, 0x2c, 0x11, 0x28, 0x80, 0x60, 0x09, 0xd5, 0x2c, 0x21,
     0x08},  // 1.2, 75
    {0xc8, 0x03, 0x39, 0x20, 0x68, 0xdc, 0x00, 0x6b, 0x2a, 0x08, 0x2a, 0x80, 0x60, 0x13, 0xa9, 0x2c, 0x21,
     0x08},  // 2.4, 335
    {0xc8, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x29, 0x04, 0x29, 0x80, 0x60, 0x27, 0x52, 0x2c, 0x21,
     0x08},  // 4.8, 335
    {0xb8, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x28, 0x82, 0x29, 0x80, 0x60, 0x4e, 0xa5, 0x2c, 0x21,
     0x08},  // 9.6, 335
    {0xa8, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x28, 0x41, 0x29, 0x80, 0x60, 0x9d, 0x49, 0x2c, 0x21,
     0x08},  // 19.2, 335
    {0x98, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x28, 0x20, 0x29, 0x80, 0x60, 0x09, 0xd5, 0x0c, 0x21,
     0x08},  // 38.4, 335
    {0x98, 0x03, 0x96, 0x00, 0xda, 0x74, 0x00, 0xdc, 0x28, 0x1f, 0x29, 0x80, 0x60, 0x0a, 0x3d, 0x0c, 0x21,
     0x08},  // 40, 335
};

RH_RF22::RH_RF22(uint8_t slaveSelectPin, uint8_t interruptPin, RHGenericSPI& spi) : RHSPIDriver(slaveSelectPin, spi) {
...
bool RH_RF22::init() {
    ...
    // Enable interrupt output on the radio. Interrupt line will now go high
    // until an interrupt occurs
    spiWrite(RH_RF22_REG_05_INTERRUPT_ENABLE1, RH_RF22_ENTXFFAEM | RH_RF22_ENRXFFAFULL | RH_RF22_ENPKSENT |
    ...
    // interruptnumber-to-interruptpin mapping yourself based on knowledge of
    ...
    // On reception the to address is check for validity against
    // RH_RF22_REG_3F_CHECK_HEADER3 or the broadcast address of 0xff If no
    // changes are made after this, the transmitted to address will be 0xff, the
    // from address will be 0xff and all such messages will be accepted. This
    // permits the out-of the box RH_RF22 config to act as an unaddresed,
...
void RH_RF22::handleInterrupt() {
    ...
    if (_lastInterruptFlags[0] & RH_RF22_IPKVALID) {
        ...
        // First make sure we dont overflow the buffer in the case of a stupid
        // length or partial bad receives
...
// RFM-22 doc appears to be wrong: WUT for wtm = 10000, r, = 0, d = 0 is about 1
// sec
...
void RH_RF22::setTxPower(uint8_t power) {
    spiWrite(RH_RF22_REG_6D_TX_POWER,
             power | RH_RF22_LNA_SW);  // On RF23, LNA_SW must be set.
}
...
void RH_RF22::setPreambleLength(uint8_t nibbles) { spiWrite(RH_RF22_REG_34_PREAMBLE_LENGTH, nibbles); }
...
void RH_RF22::startTransmit() {
    ...
    spiWrite(RH_RF22_REG_3E_PACKET_LENGTH,
             _bufLen);  // Total length that will be sent
...
// Assumption: there is currently <= RH_RF22_TXFFAEM_THRESHOLD bytes in the Tx
// FIFO
...
void RH_RF22::setGpioReversed(bool gpioReversed) {
    // Ensure the antenna can be switched automatically according to transmit
    // and receive This assumes GPIO0(out) is connected to TX_ANT(in) to enable
    // tx antenna during transmit This assumes GPIO1(out) is connected to
    // RX_ANT(in) to enable rx antenna during receive
    if (gpioReversed) {
        // Reversed for HAB-RFM22B-BOA HAB-RFM22B-BO, also Si4432 sold by
        // Dorji.com via Tindie.com.
