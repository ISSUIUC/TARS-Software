...
void SerialSimulator::begin(int baud) {
    // No implementation neccesary - Serial emulation on Linux = standard
    // console
    //
    // Initialize a timestamp for millis calculation - we do this here as well
    // in case SPI isn't used for some reason
    gettimeofday(&RHStartTime, NULL);
}
