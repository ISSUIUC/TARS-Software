...
///
/// This concrete subclass of GenericSPIClass encapsulates the standard Arduino
/// hardware and other hardware SPI interfaces.
class RHHardwareSPI : public RHGenericSPI {
#ifdef RH_HAVE_HARDWARE_SPI
   public:
    /// Constructor
    /// Creates an instance of a hardware SPI interface, using whatever SPI
    /// hardware is available on your processor platform. On Arduino and Uno32,
    /// uses SPI. On Maple, uses HardwareSPI. \param[in] frequency One of
    /// RHGenericSPI::Frequency to select the SPI bus frequency. The frequency
    ...
    /// been received It will cause the SPI_STC_vect interrupt vectr to be
    /// executed
